...
function ViewProduct() {
    ...
    function getProduct() {
        axios.get(`https://localhost:44382/api/UserProduct/${id}`)
            .then((res) => {
    ...
    const sendPostRequest = async (myCart) => {
        try {
            const resp = await axios.post('https://localhost:44382/api/MyCart', myCart);
            setMessage({
                type: "alert-success",
                msg: resp.data
            })
            ...
            <header id="main-header" className="main-header-bg">
                <div className="container inner-header">
                    <div className="title-wrap">
                        <h1 className="header-title">{myProduct.name}</h1>
                        <div className="breadcrumbs" typeof="BreadcrumbList" vocab="https://schema.org/">
                            <span property="itemListElement" typeof="ListItem">
                                ...
                                <span property="name" className="post post-product current-item">{myProduct.name}</span><meta property="url" content="https://coffo.peerduck.com/product/ethiopia-roasted-beans/" /><meta property="position" content="4" /></span>                </div>
                    </div>
                </div>
                <div id="header-wave">
                </div>
                        ...
                        <div className="col-lg-8 mx-auto content-single-product">
                            ...
                            <div id="primary" className="content-area"><main id="main" className="site-main" role="main"><nav className="woocommerce-breadcrumb"><a href="https://coffo.peerduck.com">Home</a>&nbsp;/&nbsp;<a href="https://coffo.peerduck.com/product-category/coffee-beans/">Coffee Beans</a>&nbsp;/&nbsp;Ethiopia Roasted Beans</nav><div className="woocommerce-notices-wrapper"></div><div id="product-3048" className="product type-product post-3048 status-publish first instock product_cat-coffee-beans product_tag-coffee product_tag-sweet has-post-thumbnail shipping-taxable purchasable product-type-simple">
                                ...
                                <div className="product-header">
                                    {myProduct.discount === 0 ? "" : <span className="onsale"><svg className="onsale-svg" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 60 60" xmlSpace="preserve">
                                        <g>
				...
				c0,0.3,0.1,0.6,0.4,0.9c0.2,0.2,0.6,0.4,0.9,0.4l5,0c0.7,0,1.2-0.6,1.2-1.2C48.8,34.3,48.2,33.8,47.5,33.8z"></path>
                                        ...
                                        <figure className="woocommerce-product-gallery__wrapper">
                                            <div data-thumb="https://coffo.b-cdn.net/wp-content/uploads/2020/11/ksjfjfs-100x100.png" data-thumb-alt="" className="woocommerce-product-gallery__image" style={{ position: "relative", overflow: "hidden" }}>
                                                <a href="https://coffo.b-cdn.net/wp-content/uploads/2020/11/ksjfjfs.png">
                                                    <img width="600" height="844" src={myProduct.img} className="wp-post-image" alt="" decoding="async" loading="lazy" title="ksjfjfs" data-caption="" data-src={myProduct.img} data-large_image={myProduct.img} data-large_image_width="744" data-large_image_height="1046" srcSet={`${myProduct.image} 600w,${myProduct.image} 213w,${myProduct.image} 728w,${myProduct.image} 160w,${myProduct.image} 744w`} sizes="(max-width: 600px) 100vw, 600px" /></a>
                                                <img role="presentation" alt="" src={myProduct.img} className="zoomImg" style={{ position: "absolute", top: "-553.507px", left: "-253.933px", opacity: "0", width: "744px", height: "1046px", border: "none", maxWidth: "none", maxHeight: "none" }} /></div>	</figure>
                                    </div>
                                    ...
                                    <div className="summary entry-summary">
                                        ...
                                        {myProduct.discountprice === 0
                                            ? <p className="price"><del aria-hidden="true"><span className="woocommerce-Price-amount amount"><bdi>
                                                <span className="woocommerce-Price-currencySymbol"></span></bdi></span></del> <ins>
                                                    <span className="woocommerce-Price-amount amount"><bdi><span className="woocommerce-Price-currencySymbol"></span>{myProduct.price} VNĐ
                                                    </bdi></span></ins></p>
                                            : <p className="price"><del aria-hidden="true"><span className="woocommerce-Price-amount amount"><bdi>
                                                <span className="woocommerce-Price-currencySymbol"></span>{myProduct.price}</bdi></span></del> <ins>
                                                    <span className="woocommerce-Price-amount amount"><bdi><span className="woocommerce-Price-currencySymbol"></span>{myProduct.discountprice} VNĐ
                                                    </bdi></span></ins></p>}
                                        ...
                                        <form className="cart" action="https://coffo.peerduck.com/product/ethiopia-roasted-beans/" method="post" encType="multipart/form-data">
                                            ...
                                            <button type="submit" onClick={(e) => handleAddCart(e)} name="add-to-cart" defaultValue="3048" className="single_add_to_cart_button button alt wp-element-button" >Add to cart</button>
                                        ...
                                        <div className="product_meta">
                                            ...
                                            <span className="posted_in">Category: <a href="/" rel="tag">{myProduct.catename}</a></span>
