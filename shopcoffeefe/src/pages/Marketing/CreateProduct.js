...
function CreateProduct() {
    ...
    function handleImage() {
        ...
        if (imgProduct == null) {
            element.innerHTML = "Please Select Image";
            return false;
        }
        else {
            element.innerHTML = "";
    ...
    function handleSubmit(e) {
        ...
        const sendPostRequest = async () => {
            try {
                const resp = await axios.post('https://localhost:44382/api/Product', Product);
                setMessage({
                    type: "alert-success",
                    msg: resp.data
                })
            ...
            <div className="col-lg-12 container">
                <div className="p-5">
                    <div className="text-center">
                        <h1 className="h4 text-success mb-4 ">Create Product</h1>
                    ...
                    <form className="user" method="" id="formProduct">
                        ...
                        <div className="form-group mt-2">
                            ...
                            <input type="text" className="form-control" id="inpDesc"
                        ...
                        <div className="form-group mt-2">
                            ...
                            <select className="form-control" name="category" id="inpCate"
